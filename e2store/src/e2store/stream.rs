...
/// e2s.rs was built to load full .era/.era2 files into memory and provide a simple API to access
/// the data. The issue for this is for larger files this wouldn't be feasible, as the entire file
/// would need to be loaded into memory. This is where e2store_file.rs comes in, it provides a way
/// to read and write e2store files in a streaming fashion.
