...
use super::types::{BlockWithRecoveredSenders, TransactionsWithSenders};

const EMPTY_UNCLE_ROOT_HASH: B256 =
    b256!("1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347");

pub trait BeaconBody {
    fn process_beacon_block(&self) -> BlockWithRecoveredSenders;
}
...
impl BeaconBody for SignedBeaconBlockBellatrix {
    fn process_beacon_block(&self) -> BlockWithRecoveredSenders {
        ...
        let transactions_with_recovered_senders = self
            .message
            .body
            .execution_payload
            .transactions
            .into_par_iter()
            .map(|raw_tx| {
                Transaction::decode_enveloped_transactions(&mut raw_tx.to_vec().as_slice()).expect(
                    "We should always be able to decode the enveloped transactions of a block",
                )
            })
