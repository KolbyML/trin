...
mod test {
    ...
    async fn test_launches() {
        ...
        peertest::scenarios::find::test_find_content_return_enr(
            &target,
            &peertest,
            small.next().unwrap().header_with_proof,
        )
        ...
        peertest::scenarios::validation::test_validate_pre_merge_header_with_proof(
            &peertest,
            &target,
            large.header_with_proof.clone(),
        )
        .await;
        peertest::scenarios::validation::test_invalidate_header_by_hash(
            &peertest,
            &target,
            small.next().unwrap().header_with_proof,
        )
        ...
        peertest::scenarios::validation::test_validate_pre_merge_receipts(
            ...
            &target,
            large.header_with_proof.clone(),
            large.receipts.clone(),
        )
        .await;
        peertest::scenarios::find::test_recursive_utp(
            &peertest,
            large.header_with_proof.clone(),
            large.block_body.clone(),
        )
